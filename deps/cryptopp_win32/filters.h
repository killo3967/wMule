...
public:
	...
	/// \details attachment can be nullptr.
	...
	/// \return pointer to a BufferedTransformation if there is an attached transformation, nullptr otherwise.
	...
	/// \details newAttachment can be a single filter, a chain of filters or nullptr.
	///  Pass nullptr to remove an existing BufferedTransformation or chain of filters
...
struct CRYPTOPP_DLL FilterPutSpaceHelper
{
	...
	/// \details bufferSize is an IN and OUT parameter. If HelpCreatePutSpace() returns a non-nullptr value, then
...
public:
	...
	/// \details attachment can be nullptr. The filter is transparent by default. If the filter is
