...
///  DEFAULT_CHANNEL where the string object is nullptr, then you probably have
...
///  It can be subject to <A HREF="https://isocpp.org/wiki/faq/ctors">Static
///  Initialization Order Fiasco</A>. If you experience a crash in
///  AAD_CHANNEL where the string object is nullptr, then you probably have a
...
///  It can be subject to <A HREF="https://isocpp.org/wiki/faq/ctors">Static
///  Initialization Order Fiasco</A>. If you experience a crash in
///  g_nullNameValuePairs where the string object is nullptr, then you probably
...
protected:
	...
	/// \details Internally, the default implementation checks the iv. If iv is not nullptr or nullptr,
...
public:
	...
	/// \details The base class implementation sets size to 0 and returns nullptr or nullptr.
