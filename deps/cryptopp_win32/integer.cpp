...
{
	CRYPTOPP_ASSERT(encodedInteger && byteCount); // nullptr buffer
	CRYPTOPP_ASSERT(o == BIG_ENDIAN_ORDER || o == LITTLE_ENDIAN_ORDER);
...
{
	CRYPTOPP_ASSERT(input && inputLen); // nullptr buffer
...
{
	CRYPTOPP_ASSERT(output && outputLen);            // nullptr buffer
...
{
	CRYPTOPP_ASSERT(input && len); // nullptr buffer
...
{
	CRYPTOPP_ASSERT(output && bufferSize);         // nullptr buffer
...
public:
	...
	{
		CRYPTOPP_ASSERT(output && size); // nullptr buffer
