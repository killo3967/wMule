...
public:
    /**
     * \brief Constructs a `field` holding nullptr.
     ...
     * \brief Constructs a `field` holding nullptr.
     * \details
     * Caution: `field(nullptr)` will __NOT__ match this overload. It will try to construct
    ...
    /**
     * \brief Replaces `*this` with a `nullptr`, changing the kind to `null` and destroying any
     * previous contents.
     *
     * \par Exception safety
     * No-throw guarantee.
    ...
    /**
     * \brief Returns whether this `field` is holding a `nullptr` value.
     * \par Exception safety
     * No-throw guarantee.
     */
