...
// --- Implementation  ------------------------------------------------------//
        ...
        str (const string_type& s) {
            ...
            if(sz != 0 && mode_ & (::std::ios_base::in | ::std::ios_base::out) ) {
                ...
                if(mode_ & ::std::ios_base::out) {
                    ...
                    if(gptr() == nullptr)
                        streambuf_t::setg(new_ptr, nullptr, new_ptr);
                }
                is_allocated_ = true;
            }
            else 
        ...
        begin () const {
            if(mode_ & ::std::ios_base::out && pptr() != nullptr)
                return pbase();
            else if(mode_ & ::std::ios_base::in && gptr() != nullptr)
                return eback();
            return nullptr;
        }
        ...
        seekoff (off_type off, ::std::ios_base::seekdir way, ::std::ios_base::openmode which) {
            ...
            if(which & ::std::ios_base::in && gptr() != nullptr) {
                ...
                if(eback() <= off+gptr() && off+gptr() <= putend_ ) {
                    ...
                    if(which & ::std::ios_base::out && pptr() != nullptr)
            ...
            else if(which & ::std::ios_base::out && pptr() != nullptr) {
                // put area
                if(way == ::std::ios_base::end)
...
#pragma warning(pop)
        ...
        void basic_altstringbuf<Ch, Tr, Alloc>:: dealloc() {
            if(is_allocated_)
                alloc_.deallocate(eback(), (pptr() != nullptr ? epptr() : egptr()) - eback());
            is_allocated_ = false;
