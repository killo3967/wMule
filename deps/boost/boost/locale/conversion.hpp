...
namespace boost { namespace locale {
    ...
    /// Normalize nullptr terminated Unicode string \a str according to \ref norm_type "normalization form" \a n
    ///
    /// Note: This function receives only Unicode strings, i.e.: UTF-8, UTF-16 or UTF-32. It does not take
    /// in account the locale encoding, because Unicode decomposition and composition are meaningless outside
    /// of a Unicode character set.
    ...
    /// Convert a nullptr terminated string \a str to upper case according to locale \a loc
    ///
    /// \throws std::bad_cast: \a loc does not have \ref converter facet installed
    template<typename CharType>
    ...
    /// Convert a nullptr terminated string \a str to lower case according to locale \a loc
    ///
    /// \throws std::bad_cast: \a loc does not have \ref converter facet installed
    template<typename CharType>
    ...
    /// Convert a nullptr terminated string \a str to title case according to locale \a loc
    ///
    /// \throws std::bad_cast: \a loc does not have \ref converter facet installed
    template<typename CharType>
    ...
    /// Fold case of a nullptr terminated string \a str according to locale \a loc
    ///
    /// \throws std::bad_cast: \a loc does not have \ref converter facet installed
    template<typename CharType>
