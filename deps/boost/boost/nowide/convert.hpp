...
namespace nowide {
    ...
    ///
    /// Convert wide string (UTF-16/32) in range [begin,end) to nullptr terminated narrow string (UTF-8)
    /// stored in \a output of size \a output_size (including nullptr)
    ///
    /// If there is not enough room nullptr is returned, else output is returned.
    ...
    ///
    /// Convert nullptr terminated wide string (UTF-16/32) to nullptr terminated narrow string (UTF-8)
    /// stored in \a output of size \a output_size (including nullptr)
    ///
    /// If there is not enough room nullptr is returned, else output is returned.
    /// Any illegal sequences are replaced with the replacement character, see #BOOST_NOWIDE_REPLACEMENT_CHARACTER
    ...
    ///
    /// Convert narrow string (UTF-8) in range [begin,end) to nullptr terminated wide string (UTF-16/32)
    /// stored in \a output of size \a output_size (including nullptr)
    ///
    /// If there is not enough room nullptr is returned, else output is returned.
    /// Any illegal sequences are replaced with the replacement character, see #BOOST_NOWIDE_REPLACEMENT_CHARACTER
    ...
    ///
    /// Convert nullptr terminated narrow string (UTF-8) to nullptr terminated wide string (UTF-16/32)
    /// most output_size (including nullptr)
    ///
    /// If there is not enough room nullptr is returned, else output is returned.
    /// Any illegal sequences are replaced with the replacement character, see #BOOST_NOWIDE_REPLACEMENT_CHARACTER
    ///
    ...
    /// Convert wide string (UTF-16/32) to narrow string (UTF-8).
    ///
    /// \param s nullptr terminated input string
    /// Any illegal sequences are replaced with the replacement character, see #BOOST_NOWIDE_REPLACEMENT_CHARACTER
    ///
    template<typename T_Char, typename = detail::requires_wide_char<T_Char>>
