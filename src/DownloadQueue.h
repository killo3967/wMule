...
public:
	...
	/**
	 * Returns a pointer to the file with the specified hash, or nullptr.
	 *
	 * @param filehash The hash to search for.
	 * @return The corresponding file or nullptr.
	 */
	CPartFile* GetFileByID(const CMD4Hash& filehash) const;

	/**
	 * Returns the file at the specified position in the file-list, or nullptr if invalid.
	 *
	 * @param A valid position in the file-list.
	 * @return A valid pointer or nullptr if the index was invalid.
	 */
	 ...
	 * @return The matching client or nullptr if none was found.
	 */
