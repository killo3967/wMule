...
public:
    ...
    // nullptr and the owner window is used to retrieve the item position and size
    wxRect *m_rect;
...
{
    wxListItemDataList::compatibility_iterator node = m_items.GetFirst();
    wxCHECK_MSG( node, nullptr, _T("invalid column index in GetAttr()") );
...
wxListHeaderWindow::wxListHeaderWindow()
{
    ...
    m_owner = (wxListMainWindow *) nullptr;
...
void wxListHeaderWindow::AdjustDC(wxDC& dc)
{
    ...
    int view_start;
    m_owner->GetViewStart( &view_start, nullptr );
...
void wxListMainWindow::Init()
{
    ...
    m_small_image_list = (wxImageList *) nullptr;
    m_normal_image_list = (wxImageList *) nullptr;
...
wxCoord wxListMainWindow::GetLineHeight() const
{
    ...
    if ( !m_lineHeight )
    {
        ...
        wxCoord y;
        dc.GetTextExtent(_T("H"), nullptr, &y);
...
wxTextCtrl *wxListMainWindow::EditLabel(long item, wxClassInfo* textControlClass)
{
    ...
    wxCHECK_MSG( data, nullptr, _T("invalid index in EditLabel()") );
...
wxGenericListCtrl::wxGenericListCtrl()
{
    ...
    m_imageListSmall = (wxImageList *) nullptr;
    ...
    m_mainWin = (wxListMainWindow*) nullptr;
    m_headerWin = (wxListHeaderWindow*) nullptr;
    m_headerHeight = 0;
}
