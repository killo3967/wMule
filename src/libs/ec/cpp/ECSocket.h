...
public:
	 ...
	 * or \c nullptr is returned in case of an error (timeout).
	 *
	 ...
	 * @return The reply packet or \c nullptr if no reply needed.
	 *
	 ...
	 * value of the function should be \c nullptr. The library will \c delete
	 * both packets.
	 *
