...
class CEC_SharedFile_Tag : public CECTag {
	public:
		CEC_SharedFile_Tag(const CKnownFile *file, EC_DETAIL_LEVEL detail_level,
							CValueMap *valuemap = nullptr, ec_tagname_t name = EC_TAG_KNOWNFILE);
...
class CEC_PartFile_Tag : public CEC_SharedFile_Tag {
	public:
		CEC_PartFile_Tag(const CPartFile *file, EC_DETAIL_LEVEL detail_level, CValueMap *valuemap = nullptr);
...
class CEC_SearchFile_Tag : public CECTag {
	public:
		CEC_SearchFile_Tag(const CSearchFile *file, EC_DETAIL_LEVEL detail_level, CValueMap *valuemap = nullptr);
