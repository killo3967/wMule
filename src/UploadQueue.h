...
public:
	...
	CUpDownClient* GetWaitingClientByIP_UDP(uint32 dwIP, uint16 nUDPPort, bool bIgnorePortOnUniqueIP, bool* pbMultipleIPs = nullptr);
...
private:
	...
	void	SortGetBestClient(CClientRef * bestClient = nullptr);
