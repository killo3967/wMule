...
// For sets and maps
	...
	void Unlink();
	bool IsLinked() const		{ return m_client != nullptr; }
...
// Wrapper methods
	...
	bool				SwapToAnotherFile(bool bIgnoreNoNeeded, bool ignoreSuspensions, bool bRemoveCompletely, CPartFile* toFile = nullptr) const;	// only wrapper const
