...
m_proxyClientSocket(nullptr),
m_proxyBoundAddress(nullptr),
// Temporary variables
m_lastReply(0),
m_packetLenght(0)
{
...
:
CLibSocket(flags),
m_proxyStateMachine(nullptr),
m_udpSocket(udpSocket)
#ifndef ASIO_SOCKETS
,m_socketEventHandler(nullptr)
,m_socketEventHandlerId(0)
,m_savedSocketEventHandler(nullptr)
...
{
	m_useProxy = proxyData != nullptr && proxyData->m_proxyEnable;
	if (proxyData) {
		m_proxyData = *proxyData;
