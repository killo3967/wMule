...
void CStatisticsDlg::ApplyStatsColor(int index)
{
	...
	static COScopeCtrl** apscope[] = { nullptr, nullptr, &pscopeDL,&pscopeDL,&pscopeDL, &pscopeUL,&pscopeUL,&pscopeUL, &pscopeConn,&pscopeConn,&pscopeConn };
	...
	switch (index) {
		...
		case 8:  case 9:  case 10:
				...
				if ((ctrl = CastChild(iRes, CColorFrameCtrl)) == nullptr) {
