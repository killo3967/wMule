...
public:
	 ...
	 *
	 * @param widget The widget which would receive the event or nullptr to disable.
	 *
	 * Setting the handler to a non-nullptr pointer means that upon right-clicks, a
...
protected:
	...
	//! The pointer to the widget which would receive right-click events or nullptr.
