...
public:
	...
	bool		IsFriend() const		{ return m_Friend != nullptr; }
	...
	void		ClearUploadFileID()		{ m_requpfileid.Clear(); m_uploadingfile = nullptr;}
	...
	bool		SwapToAnotherFile(bool bIgnoreNoNeeded, bool ignoreSuspensions, bool bRemoveCompletely, CPartFile* toFile = nullptr);
	 ...
	 *
	 * @param socket The pointer to the new socket, can be nullptr.
	 *
	 ...
	 *
	 * @return The pointer (can be nullptr) to the socket used by this client.
	 *
