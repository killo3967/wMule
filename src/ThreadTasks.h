 ...
 * first constructor, with part == nullptr), both MD4 and
...
public:
	 ...
	 */
	CHashingTask(const CPath& path, const CPath& filename, const CPartFile* part = nullptr);
...
public:
	 ...
	 * @param result
	 */
	CHashingEvent(wxEventType type, CKnownFile* result, const CKnownFile* owner = nullptr);

	/** @see wxEvent::Clone */
	virtual wxEvent* Clone() const;

	/** Returns the owner (may be nullptr) of the hashing result. */
...
#define EVT_MULE_HASHING(func) \
	...
	wxStaticCastEvent(MuleHashingEventFunction, &func), (wxObject*) nullptr),
...
#define EVT_MULE_FILE_COMPLETED(func) \
	...
	(wxObjectEventFunction) (wxEventFunction) \
	wxStaticCastEvent(MuleCompletionEventFunction, &func), (wxObject*) nullptr),
...
#define EVT_MULE_ALLOC_FINISHED(func) \
	...
	(wxObjectEventFunction) (wxEventFunction) \
	wxStaticCastEvent(MuleAllocFinishedEventFunction, &func), (wxObject*) nullptr),
