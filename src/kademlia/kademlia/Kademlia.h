...
public:
	...
	static CPrefs *			GetPrefs() throw()		{ if (instance == nullptr || instance->m_prefs == nullptr) return nullptr; else return instance->m_prefs; }
	static CRoutingZone *		GetRoutingZone()		{ wxCHECK(instance && instance->m_routingZone, nullptr); return instance->m_routingZone; }
	static CKademliaUDPListener *	GetUDPListener()		{ wxCHECK(instance && instance->m_udpListener, nullptr); return instance->m_udpListener; }
	static CIndexed *		GetIndexed()			{ wxCHECK(instance && instance->m_indexed, nullptr); return instance->m_indexed; }
