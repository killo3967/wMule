...
// 	uint8_t packet[] = {
// 		0x07,
// 		//Tag1 0x02, 0x01, 0x00, 0x01, 0x20, 0x00, 0x47, 0x65, 0x6d, 0x20, 0x42, 0x6f, 0x79, 0x20, 0x2d,
// 		0x20, 0x53, 0x61, 0x72, 0x61, 0x20, 0x70, 0x65, 0x72, 0x63, 0x68, 0x65, 0x20, 0x74,
...
// 
// 	CheckTagData(*it++, TAG_FILENAME, valid_tag_value(wxT("Gem Boy - Sara perche ti amo.mp3")));
...
// 	TEST_M(CTag, ReadTagList2, wxT("Kad: Parse taglist from Kad packet with ASCII string"))
// {
// 	uint8_t packet[] = {
// 		0x05,
// 		//Tag1 0x02, 0x01, 0x00, 0x01, 0x23, 0x00, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x61,
// 		0x74, 0x69, 0x6f, 0x6e, 0x20, 0x54, 0x65, 0x73, 0x74, 0x20, 0x46, 0x69, 0x6c, 0x65, 0x20, 0x31,
// 		0x38, 0x39, 0x33, 0x2d, 0x45, 0x45, 0x45, 0x2e, 0x74, 0x78, 0x74,
...
// 	TagPtrList::iterator it = taglist.begin();
// 
// 	CheckTagData(*it++, TAG_FILENAME, valid_tag_value(wxT("Serialization Test File 1893-EEE.txt")));
